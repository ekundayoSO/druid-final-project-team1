...
class __TwigTemplate_61757725148e1b721d61c1a95daadfa6 extends Template
{
    ...
    <a class=\"mautic-brand";
        // line 4
        yield ((Twig\Extension\CoreExtension::testEmpty((isset($context["extraMenu"]) || array_key_exists("extraMenu", $context) ? $context["extraMenu"] : (function () { throw new RuntimeError('Variable "extraMenu" does not exist.', 4, $this->source); })()))) ? ("") : (" pull-left pl-0 pr-0"));
        yield "\" href=\"#\">
        <!-- logo figure -->
    ...
    ";
        // line 43
        if ( !Twig\Extension\CoreExtension::testEmpty((isset($context["extraMenu"]) || array_key_exists("extraMenu", $context) ? $context["extraMenu"] : (function () { throw new RuntimeError('Variable "extraMenu" does not exist.', 43, $this->source); })()))) {
            // line 44
            yield "        <div class=\"dropdown extra-menu\">
            <a href=\"#\" data-toggle=\"dropdown\" class=\"dropdown-toggle\">
                <i class=\"fa fa-chevron-down fa-lg\"></i>
            </a>
            ";
            // line 48
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape((isset($context["extraMenu"]) || array_key_exists("extraMenu", $context) ? $context["extraMenu"] : (function () { throw new RuntimeError('Variable "extraMenu" does not exist.', 48, $this->source); })()), "html", null, true);
            yield "
        </div>
    ";
        }
    ...
    <div class=\"scroll-content slimscroll\">
        ...
        yield "
            ...
            <ul class=\"nav sidebar-left-dark\">
                <li class=\"hidden-xs\">
                    <a href=\"javascript:void(0)\" data-toggle=\"minimize\" class=\"sidebar-minimizer\" aria-label=\"";
        // line 67
        yield $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("mautic.core.menu.left.collapse", [], "messages");
        yield "\"><span class=\"direction icon pull-left fa\"></span><span class=\"nav-item-name pull-left text\">";
        yield $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("mautic.core.menu.left.collapse", [], "messages");
        yield "</span></a>
                </li>
            </ul>
...
<!--/ end: sidebar-content -->";
    ...
    {
        return array (  128 => 67,  120 => 62,  116 => 61,  104 => 51,  98 => 48,  92 => 44,  90 => 43,  48 => 4,  44 => 2,  42 => 1,);
    }

    public function getSourceContext(): Source
    {
        return new Source("", "@MauticCore/LeftPanel/index.html.twig", "/app/docroot/app/bundles/CoreBundle/Resources/views/LeftPanel/index.html.twig");
    }
}
