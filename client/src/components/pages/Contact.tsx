    ...
    <div className='relative w-full overflow-auto min-h-screen bg-gray-700 m-0 p-0'>
      <div className='flex flex-col md:flex-row items-center justify-center h-full w-full min-h-screen'>
        <div className='flex flex-col items-center justify-center w-full md:w-1/2 h-full p-8'>
          ...
          Our magic happens at our base in Länsi-Pasila, Helsinki, where close to thirty tech maestros are dedicated to creating uncompromising digital solutions.
          </p>
    ...
    <h2 className='text-3xl font-bold text-white mb-4'>Send us a mes­sa­ge</h2>
        <div className='flex flex-col md:flex-row items-center justify-center w-full md:w-1/2 h-full p-8'>
          ...
          <form className='w-full max-w-lg'>
            ...
            <div className='mb-4'>
              <label htmlFor='company' className='block text-white text-sm font-bold mb-2'>Company</label>
            ...
            <div className='mb-4'>
              ...
              <textarea id='message' name='message' required className='shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline' rows={3}></textarea>
            </div>
            <div className='flex items-center justify-center'>
            <button className="bg-gray-300 text-gray-800 rounded-full px-4 py-2 mx-2">
                Send Message
              </button>
            </div>
          </form>
          <div className='bg-gray-600 rounded-lg shadow-lg overflow-hidden p-4 md:ml-16'>
            ...
            <button className="bg-gray-500 text-gray-300 rounded-full px-2 mt-4 py-1 mx-1">Billing information</button>
          </div>
        </div>
        </div>
        </div>
...
We see it as dedication – someone else might call it nerdy. Our passion is to find the best digital solutions for our clients. And we don’t hide from the challenge. We believe in openness in source, but also in how we cooperate.
<br/>
...
<div className='flex flex-col items-center justify-center'>
  <div className='flex flex-wrap justify-center'>
    <div className='rounded-lg overflow-hidden p-4 mb-2 mr-2 min-h-300 max-w-sm'>
      <img src="https://via.placeholder.com/150" alt="Mikko Hämäläinen" className='w-full h-auto object-cover mb-2 rounded-full' />
    ...
    <div className='rounded-lg overflow-hidden p-4 mb-2 mr-2 min-h-300 max-w-sm'>
      <img src="https://via.placeholder.com/150" alt="Pasi Järnsstedt" className='w-full h-auto object-cover mb-2 rounded-full' />
      <div className='text-center'>
    ...
    <div className='rounded-lg overflow-hidden p-4 mb-2 mr-2 min-h-300 max-w-sm'>
      <img src="https://via.placeholder.com/150" alt="Arto Iijäläinen" className='w-full h-auto object-cover mb-2 rounded-full' />
      <div className='text-center'>
        <h3 className='text-sm font-semibold text-gray-300'>Arto Iijäläinen</h3>
        <p className='text-xs text-gray-300'>Project Manager &<br/> Scrum Master</p>
      </div>
    </div>
    <div className='rounded-lg overflow-hidden p-4 mb-2 mr-2 min-h-300 max-w-sm'>
      <img src="https://via.placeholder.com/150" alt="Anne Klementti" className='w-full h-auto object-cover mb-2 rounded-full' />
      <div className='text-center'>
    ...
    <div className='rounded-lg overflow-hidden p-4 mb-2 mr-2 min-h-300 max-w-sm'>
      <img src="https://via.placeholder.com/150" alt="Jesse Tikka" className='w-full h-auto object-cover mb-2 rounded-full' />
      <div className='text-center'>
    ...
    <div className='rounded-lg overflow-hidden p-4 mb-2 mr-2 min-h-300 max-w-sm'>
      <img src="https://via.placeholder.com/150" alt="Erika Vanhala" className='w-full h-auto object-cover mb-2 rounded-full' />
      <div className='text-center'>
    ...
    <div className='rounded-lg overflow-hidden p-4 mb-2 mr-2 min-h-300 max-w-sm'>
      <img src="https://via.placeholder.com/150" alt="Kirsi Vatanen" className='w-full h-auto object-cover mb-2 rounded-full' />
      <div className='text-center'>
...
In­te­res­ted in joi­ning our team?    </h2>
<button className="bg-gray-300 text-gray-800 rounded-full px-4 py-2 mx-2 my-10 mb-20">Take a look at our open positions</button>
</div>
